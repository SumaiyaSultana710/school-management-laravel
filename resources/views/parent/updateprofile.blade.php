                ...
                <form method="POST" class="col-12 " action="{{route('parent.updateprofile')}}">
                    ...
                    <div class="col-12">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="email" id="email" name="email" class="form-control"  value="{{$parent->parentgmail}}" required>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="password" id="password" name="password" class="form-control"  value="{{$parent->password}}" >
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="occupation" name="occupation" class="form-control"  value="{{$parent->parentoccupation}}" required>
                                <div class="alert-secondary">{{ $errors->first('occupation') }}</div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="parentrelation" name="parentrelation" class="form-control"  value="{{$parent->relation}}" required>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="phone" name="phone" class="form-control"  value="{{$parent->parentcontact}}"required>
