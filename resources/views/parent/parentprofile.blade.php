                ...
                <form class="col-12 profileAjaxForm" >
                    ...
                    <div class="col-12">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <label class="col-md-3 col-form-label" >{{$parent->parentoccupation}}</label>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <label class="col-md-6 col-form-label">{{$parent->parentgmail}}</label>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <label class="col-md-3 col-form-label">{{$parent->relation}}</label>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <label class="col-md-6 col-form-label">{{$parent->parentcontact}}</label>
                            </div>
                        </div>
